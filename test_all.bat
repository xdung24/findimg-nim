@echo off
REM Test script for findimg_nim using the copied test images
...
REM Test 2: Command line tool with text output
...
REM Test 3: Command line tool with JSON output
